...
class HTML {
  ...
  /// as its argument.
  static TextSpan toTextSpan(BuildContext context, String htmlContent, HexColor fontColor,
      {Function linksCallback}) {
    Parser p = Parser(context, htmlContent, fontColor, linksCallback: linksCallback);
  ...
  /// click events on anchor tags. The function will receive the actual link
  /// as its argument.
  static RichText toRichText(BuildContext context, String htmlContent, HexColor fontColor,
      {Function linksCallback}) {
    return RichText(
        text: toTextSpan(context, htmlContent, fontColor, linksCallback: linksCallback));
  }
}
