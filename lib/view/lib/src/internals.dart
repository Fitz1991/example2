...
class Parser {
  ...
  Parser(BuildContext context, String data, HexColor _fontColor, {Function linksCallback}) {
  ...
  TextSpan _getTextSpan(text, style) {
    ...
    if(fontColor != null) textStyle = textStyle.apply(color: fontColor);
    else textStyle = textStyle.apply(color: HexColor("#708160"));
